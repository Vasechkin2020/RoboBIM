...
// Установка положения. Пссле команды 1 милисекунду к мотору обращаться за информацией нелья
int LSSProtocol::SetPos(u8 ID, u16 pos, u16 time) // Установка положения. Пссле команды 1 милисекунду к мотору обращаться за информацией нелья
{
