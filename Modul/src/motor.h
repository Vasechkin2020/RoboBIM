...
void setZeroMotor()
{
    setSpeedMotor(0.75); // Устанавливаем скорость вращения моторов и в дальнейшем только флагами включаем или отключаем вращение
    ...
    delay(5000);                // Время что-бы успел доехать до концевика
